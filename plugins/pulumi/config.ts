...
import { DeepPrimitiveMap, joi, joiSparseArray, joiStringMap, joiVariables } from "@garden-io/core/build/src/config/common"
...
export const pulumiModuleSchema = () =>
  joi.object().keys({
    ...
    `),
    pulumiVarfiles: joiSparseArray(joi.posixPath().pattern(yamlFileRegex))
      .description(
        dedent`
